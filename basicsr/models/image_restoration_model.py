...
class ImageCleanModel(BaseModel):
    ...
    def init_training_settings(self):
        ...
        print('used loss is:', self.cri_pix, self.cri_fft, self.cri_perceptual)
    ...
    def optimize_parameters(self, current_iter):
        ...
        #     l_perc = self.cri_perceptual(preds, self.gt)
        #     l_total += l_perc
    ...
    def dist_validation(self, dataloader, current_iter, tb_logger, save_img, rgb2bgr,
                        use_image):
